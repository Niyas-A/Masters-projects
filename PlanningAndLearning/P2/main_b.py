...
def runtest(mapfile, start, goal, verbose = True):
    ...
    path = rrt_planner(start, goal, boundary[0], blocks, max_samples = 150000)
    # print(type(path))
...
if __name__=="__main__":
    test_single_cube() # rrt - 0.5,0.01,0.3 - 11 path 8, rrt- 1,0.05,0.1 - 19 p 9
    test_maze() # bid_h>10k, bid>10k, rrt - 0.5,0.01,0.3 - 25340 path 116, rrt - 1,0.05,0.1 - 18519 path 121
    test_flappy_bird() # rrt - 0.5,0.01,0.3 - 807 path 36, rrt- 1,0.05,0.1 - 261 p 38
    test_monza() # 1642 bid_h, rrt- 1,0.05,0.1 - 94159 p 114
    test_window() # q = 0.5, r = 0.01, max_samples = 10000, prc = 0.3, rrt- 1,0.05,0.1 - 172 p 29
    test_tower() # rrt- 1,0.05,0.1 - 1642 p 43
    test_room() # rrt- 1,0.05,0.1 - 213 p 16
    plt.show(block=True)
