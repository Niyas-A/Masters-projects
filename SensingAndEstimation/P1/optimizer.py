...
yaw_vicon, pitch_vicon, roll_vicon = jax.vmap(rotation_matrix_to_euler, in_axes=2)(A)
...
plt.plot(At, yaw_vicon, label='Vicon Yaw')
...
plt.plot(At, pitch_vicon, label='Vicon Pitch')
...
plt.plot(At, roll_vicon, label='Vicon Roll')
